...
class QuoteTweetTextInput extends StatefulWidget {
  QuoteTweetTextInput(this.textController, {super.key});
  final textController;

  @override
  State<QuoteTweetTextInput> createState() => _QuoteTweetTextInputState();
}

class _QuoteTweetTextInputState extends State<QuoteTweetTextInput> {
  String? userPic;
